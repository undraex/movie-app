...
// export default function MovieCard({ rating, title, imageUrl, id, minimumWidth}) {
...
// >
//   <div
//     style={{ width: getMinimumWidth, height: "435px" }}
      ...
      >
        <div
          style={{
            backgroundImage: `url(${imageUrl})`,
            width: cardWidth,
            height: "75%", // roughly proportional to your original layout
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
          className="rounded-t-sm"
